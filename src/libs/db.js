...
db.serialize(() => {
  ...
  db.run("CREATE TABLE IF NOT EXISTS student_detail (id INTEGER PRIMARY KEY AUTOINCREMENT, course_id TEXT, subcalendar_id TEXT, name TEXT, code TEXT,en state TEXT, parent_name DATETIME, parent_code TEXT,read TEXT, write TEXT, level TEXT, evaluate TEXT, remarks TEXT, homework TEXT, value1 TEXT,value2 TEXT,value3 TEXT,value4 TEXT,value5 TEXT)");
